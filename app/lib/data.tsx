...
export const project: ProjectData[] = [
    {id: 1, name: 'Pomodoro Timer', description: 'This porject uses NextJS to create a gentle pomodoro timer that creates a soundscape for you to use as background music to complete your tasks.', gitUrl: 'https://github.com/Duck-Method/NextJS-Webpage', liveUrl: 'https://nextjs-webpage-hlm5.onrender.com/', img: '/pomodoroTimer.png',},
